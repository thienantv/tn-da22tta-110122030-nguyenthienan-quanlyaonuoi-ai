...
CREATE TABLE seasons (
    ...
    note TEXT,
	harvest_request_status VARCHAR(20) DEFAULT NULL, -- Trạng thái: PENDING, APPROVED, REJECTED
	harvest_request_date DATE DEFAULT NULL,          -- Ngày Kỹ sư xin thu hoạch
	harvest_request_note TEXT DEFAULT NULL;          -- Lý do / Giải trình của Kỹ sư
);
